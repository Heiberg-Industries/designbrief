...
- Glassmorphism: frosted glass, backdrop-blur, vibrant gradient blobs, translucent surfaces
- Neubrutalism: 3px black borders, hard offset shadows, bright colors, bold typography
...
| Style | Key Visual Markers |
|---|---|
| Anti-Design | Broken grid, clashing colors, mixed fonts, intentional chaos |
| Art Deco | Gold/metallic accents, geometric ornament, dark backgrounds, symmetry |
| Aurora | Gradient mesh backgrounds, vibrant colors, clean UI on top |
| Bauhaus | 0px radius, 2px borders, primary colors (red/yellow/blue), geometric |
| Bento Grid | Mixed-size tiles, tight gaps, self-contained modules |
| Claymorphism | Puffy clay shadows (inner highlight + outer), pastels, 24px+ radius |
...
| Minimalism | Extreme whitespace, monochromatic, typography-only hierarchy |
| Neubrutalism | 3px borders, hard offset shadows, bright/loud colors |
| Neumorphism | Same-color surfaces, dual light/dark shadows, soft emboss |
| Organic | Blob shapes, wave dividers, nature colors, pill buttons |
| Retro-Futurism | Neon glow, dark backgrounds, sci-fi typography, grid lines |
| Skeuomorphism | Realistic gradients, beveled edges, material textures, embossed text |
| Swiss | Mathematical grid, 0px radius, one accent color, Helvetica |
| Y2K Revival | Chrome gradient text, glossy highlights, baby blue + hot pink |
